...
const BLOG = {
  AUTHOR: 'trylang', // 作者
  BIO: '生命不息、折腾不止', // 作者简介
  LINK: 'https://trylang.com', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '15d115babab049e7b3978a3b04aa9daf', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'tryjane@qq.com',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/trylang',
  CONTACT_TELEGRAM: '',
